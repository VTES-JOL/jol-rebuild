...
Documents game creation, lifecycle, registration, and real-time update behaviour in JOL.

See [VTES Rules — Game Flow](../rules/game-flow.md) for the tabletop format rules and table-size limits this implements.
