# Tournament Lobby — Implementation

Documents the tournament lifecycle, player registration, seating, activation, and game creation in JOL.

See [VTES Rules — Tournament](../rules/tournament.md) for the VTES tournament format rules this implements.
