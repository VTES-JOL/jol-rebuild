...
- Trophy awards for Red List minions, if applicable, are resolved **before** the blood hunt referendum is called. See [Game Flow § Minion Traits](./game-flow.md#minion-traits).
